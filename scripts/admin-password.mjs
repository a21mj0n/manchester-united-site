...
console.log("\nServerga o'rnatish uchun eng oson yo'l:");
console.log("  ./deploy/set-admin-password.sh");
console.log("\nQo'lda qilmoqchi bo'lsangiz: /etc/red-devils.env faylidagi");
console.log("ADMIN_PASSWORD_HASH qatorini almashtiring, keyin");
console.log("  sudo systemctl restart red-devils");
